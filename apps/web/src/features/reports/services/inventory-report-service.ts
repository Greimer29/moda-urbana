...
function buildInventoryQueryParams(params: InventoryReportParams) {
  ...
  if (params.movement_from) search.set('movement_from', params.movement_from)
  if (params.movement_to) search.set('movement_to', params.movement_to)
  if (params.movement_month) search.set('movement_month', params.movement_month)
