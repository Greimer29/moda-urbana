...
const PROTECTED_API_ROUTES: Array<[string, string]> = [
  ...
  ['GET', '/product-folders'],
  ['GET', '/product-folders/42'],
  ['POST', '/product-folders'],
  ['PUT', '/product-folders/42'],
  ['DELETE', '/product-folders/42'],
  ['POST', '/product-folders/42/products'],
  ['DELETE', '/product-folders/42/products/7'],
